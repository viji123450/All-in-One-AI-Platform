...
import { Eraser,FileText,Hash,House,Image,Scissors, SquarePen,Users,LogOut } from 'lucide-react'; // Importing the House icon
      ...
      <div className='px-6 mt-5 text-sm text-gray-600 font-medium'>
        {navItems.map(({ to, label, Icon }) => (
          <NavLink
            ...
            className={({ isActive }) =>
              `px-3.5 py-2 flex items-center gap-3 rounded ${isActive ? 'bg-gradient-to-r from-[#3C81F6] to-[#9234EA] text-white' : ''}`
            }
          >
            {({ isActive }) => (
              <>
